export const ownerChallenge = {
  en: {
    eyebrow: "The owner’s challenge",
    ...
    items: [
      ...
      { label: "Managing Airbnb & Booking.com" },
      { label: "Cleaning & laundry" },
      { label: "Maintenance & repairs" },
      { label: "Late-night emergencies" },
      { label: "Pricing optimization" },
      { label: "Guest screening & security" },
    ],
  },
  fr: {
    eyebrow: "Le défi du propriétaire",
    ...
    items: [
      ...
      { label: "Gestion d'Airbnb et Booking.com" },
      { label: "Ménage et blanchisserie" },
      { label: "Entretien et réparations" },
      { label: "Urgences nocturnes" },
      { label: "Optimisation tarifaire" },
      { label: "Vérification et sécurité des voyageurs" },
    ],
  },
} as const;
