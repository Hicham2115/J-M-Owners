const clauses = [
  {
    ...
    answer: "Yes. Tell us the dates you want to block and we close the calendar around them — no fees, no questions asked.",
  },
  {
    question: "What happens if a guest damages something?",
    answer: "Every booking carries a security deposit and damage coverage. We handle the claim — you don't chase a guest over a broken lamp.",
  },
  {
    question: "How and when do I get paid?",
    answer: "Net revenue is transferred to you monthly, with a full breakdown of bookings, expenses and occupancy attached.",
  },
  {
    question: "What's your commission, exactly?",
    answer: "A single percentage of booking revenue, agreed before you sign. No setup fees, no hidden charges.",
  },
  {
    question: "Can I end the contract if it's not working?",
    answer: "Yes, with 30 days' notice at any time. We'd rather earn your trust every month than lock you into it.",
  },
  {
...
export function Faq() {
  return (
    <section className="bg-white px-5 py-14 sm:px-8 sm:py-20 lg:px-12 lg:py-24" id="faq">
      <div className="mx-auto max-w-5xl">
        ...
        <h2 className="max-w-xl font-serif font-medium text-4xl leading-[1.12] tracking-tight sm:text-5xl">
          The fine print, in <span className="italic text-gold-dark">plain English</span>.
        </h2>
